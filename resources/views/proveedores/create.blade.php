       ...
       <p class="text-danger"> Campo obligatorio (*).</p>
        ...
        <div class="row mb-3"> 
                ...
                <div class="col"> 
                  ...
                  <input maxlength="10"  placeholder="Ingrese NIT o Cè
                  ...
                  dula" value="{{ old('nit')}}" onkeypress="return event.charCode>= 48&& event.charCode <=57" id="nit" name="nit" type="text" class="form-control" tabindex="1"> 
                  @if($errors->has('nit'))
